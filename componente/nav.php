...
<div class="container-fluid" style="background-color: #CBF3F0;">
    <header class="d-flex flex-wrap justify-content-center py-3 border-bottom">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-item"><a href="index.php?sec=mangaXcat&gen=1" class="nav-link">Acción</a></li>
            <li class="nav-item"><a href="index.php?sec=mangaXcat&gen=2" class="nav-link">Fantasía</a></li>
            <li class="nav-item"><a href="index.php?sec=mangaXcat&gen=3" class="nav-link">Suspenso</a></li>
